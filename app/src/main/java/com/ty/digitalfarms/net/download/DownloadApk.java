package com.ty.digitalfarms.net.download;
...
public class DownloadApk {
    ...
    private static void startInstall(Context context, Uri uri) {
        Log.e("安装链接", Utils.getFilePathFromContentUri(uri)+"");

        Intent install = new Intent();
        install.setDataAndType(Uri.parse("file://"+ Utils.getFilePathFromContentUri(uri)), "application/vnd.android.package-archive");
