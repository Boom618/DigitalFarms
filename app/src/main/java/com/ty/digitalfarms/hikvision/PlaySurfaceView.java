package com.ty.digitalfarms.hikvision;
  ...
  /*  public PlaySurfaceView(Activity demoActivity) {
    ...
    public void surfaceCreated(SurfaceHolder arg0) {
       ...
       // setZOrderOnTop(true);
        ...
        if (surface.isValid()) {
            if (!Player.getInstance().setVideoWindow(m_iPort, 0, arg0)) {
    ...
    private RealPlayCallBack getRealPlayerCbf() {
        RealPlayCallBack cbf = new RealPlayCallBack() {
            public void fRealDataCallBack(int iRealHandle, int iDataType, byte[] pDataBuffer, int iDataSize) {
                //iRealHandle==0,iDataType==2
                //  Log.e(TAG,"getRealPlayerCbf---"+iRealHandle+"---"+iDataType+"---"+pDataBuffer+"----"+iDataSize);
    ...
    private void processRealData(int iPlayViewNo, int iDataType, byte[] pDataBuffer, int iDataSize, int iStreamMode) {
        //   Log.e(TAG, "iPlayViewNo:" + iPlayViewNo + ",iDataType:" + iDataType + ",iDataSize:" + iDataSize);
